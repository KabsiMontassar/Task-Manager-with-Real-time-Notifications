...
const Board = ({ light, dark, fontColor }: BoardProps) => {
  return (
    <>
      <Heading mb={10} fontSize="1.5rem" color={fontColor}>TaskManagement</Heading>
      
      <Grid   templateColumns='repeat(3, 1fr)' gap={6}>
        <GridItem  w='100%' h='70vh' bg={light} p={3} borderRadius={5} >
          <Heading mb={3} fontSize="1.2rem" textAlign={"center"} color={"#C68EFD"}>Todos</Heading>
          <Flex direction="column" gap={5}  h="100%">
            <Task light={light} dark={dark} fontColor={fontColor} />
            <Task light={light} dark={dark}  fontColor={fontColor} />
          </Flex>
        ...
        <GridItem gap={50}  w='100%' h='70vh' bg={light} p={3} borderRadius={5} >
